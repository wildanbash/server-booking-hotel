...
seeder.connect('mongodb://localhost:27017/db_booking_hotel', { 
  ...
  seeder.clearModels(['Bank', 'Item', 'Member', 'Item', 'Feature', 'Image', 'Booking', 'Users'], function () {
    ...
    'documents': [
      {
        ...
        firstName: 'Wildan',
        lastName: 'Dawam Bash',
        email: 'wildandawambash@gmail.com',
        phoneNumber: '089697574547'
      },
      {
        _id: mongoose.Types.ObjectId('5e96cbe292b97300fc903334'),
        firstName: 'Rahmad',
        lastName: 'Alfian',
        email: 'rahmadalfian@gmail.com',
        phoneNumber: '089672635791'
      }
    ]
  },
  {
    ...
    'documents': [
      {
        ...
        bankName: 'BNI',
        nomorRekening: '7120520002',
        name: 'Wildan Dawam Bash',
