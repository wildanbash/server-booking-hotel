...
module.exports = {
  ...
  addItem: async (req, res) => {
    try {
      const { title, price, city, about } = req.body;
  ...
  showImageItem: async (req, res) => {
    try {
      ...
      res.render('admin/item/view_item', {
        title: "BookingHotel | Show Image Item",
        alert,
        item,
        action: 'show image',
        user: req.session.user
  ...
  viewDetailItem: async (req, res) => {
    ...
    try {
      ...
      res.render('admin/item/detail_item/view_detail_item', {
        title: 'BookingHotel | Detail Item',
        alert,
        itemId,
        feature,
        user: req.session.user
  ...
  addBooking: async (req, res) => {
    try {
      req.flash("alertMessage", "Success Add Booking");
      req.flash("alertStatus", "success");
  ...
  showDetailBooking: async (req, res) => {
    ...
    try {
      ...
      res.render('admin/booking/show_detail_booking', {
        title: "BookingHotel | Detail Booking",
        user: req.session.user,
        booking,
        alert
      });
  ...
  deleteUser: async (req, res) => {
    try {
      ...
      const user = await Users.findOne({ _id: id });
      await user.remove();
      req.flash("alertMessage", "Success User Category");
      req.flash("alertStatus", "success");
      res.redirect("/admin/user");
    } catch (error) {
      req.flash("alertMessage", `$error.message`);
